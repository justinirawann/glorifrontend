  ...
  return (
    <div className="bg-black text-white font-sans">
      ...
      <section className="relative min-h-screen flex flex-col justify-center px-12 md:px-24 pt-24">
        ...
        <h1 className="text-5xl md:text-7xl font-serif max-w-4xl leading-tight mb-2 relative z-10">
    ...
    {/* CONTAINER UTAMA */}
    <div className="relative w-full md:w-[78%] h-[520px] rounded-[50px] shadow-2xl bg-black">
        
        {/* INNER CONTAINER (Buat masking gambar) */}
     ...
     {/* --- SECTION 4: STATS --- */}
        ...
        <div className="px-12 md:px-24 grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            ...
            <h3 className="text-3xl font-serif mb-2">Quality & Reliability</h3>
            <p className="text-xs text-gray-400 uppercase tracking-widest max-w-xs">
      ...
      <section className="py-32 bg-black text-center px-12">
        <h2 className="text-4xl font-serif mb-4">Our Client</h2>
        <p className="text-gray-500 mb-16 uppercase tracking-widest text-sm">Trusted by individuals and organizations across various industries.</p>
        
        <div className="flex flex-wrap justify-center gap-8 mb-32">
            {[1, 2, 3, 4, 5, 6].map(i => (
                <div key={i} className="w-32 h-32 bg-gray-900 rounded-2xl grayscale opacity-50 hover:opacity-100 transition-all cursor-pointer"></div>
            ))}
        </div>

        <div className="relative h-[600px] w-full flex items-center justify-center overflow-hidden rounded-3xl">
